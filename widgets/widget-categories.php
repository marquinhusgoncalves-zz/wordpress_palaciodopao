...
class pp_categories extends WP_Widget
{
	 function pp_categories(){
        ...
        $widget_ops = array('classname' => 'pp-cats','description' => __( "pp Categories" ,'pp') );
		    $this->WP_Widget('pp-cats', __('pp Categories','pp'), $widget_ops);
    }

    function widget($args , $instance) {
    	extract($args);
        $title = ($instance['title']) ? $instance['title'] : __('Categories' , 'pp');
        $enable_count = '';
    ...
    function form($instance) {
      ...
      <p><label for="<?php echo $this->get_field_id('limit'); ?>"> <?php _e('Limit Categories ','pp') ?></label>
      ...
      <p><label>
        <input  type="checkbox"
         ...
         />
         <?php _e('Enable Posts Count','pp') ?></label>
       </p>
