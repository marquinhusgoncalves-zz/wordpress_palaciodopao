...
<div style="background-color: #EFEEEA; padding: 20px">
	...
	<div class="row encomendas" style="width: auto; margin: 0 auto; text-align: center;">
		...
		<div class="col-lg-6">
		  <img id="imgZoom" src="<?php bloginfo('stylesheet_directory');?>/img/_encomendas/2334_Cardapio-Encomendas-10.jpg" alt="" />
		</div>

		<div class="col-lg-6">
		  <img id="imgZoom" src="<?php bloginfo('stylesheet_directory');?>/img/_encomendas/2334_Cardapio-Encomendas-11.jpg" alt="" />
		</div>
