...
<div class = "bg-cardapio">
	<div class = "clearfix produto cardapio">
		<div class = "col-lg-6"><img src = "<?php bloginfo('stylesheet_directory');?>/img/_copa/07.jpg" alt = "" /></div>
		<div class = "col-lg-6"><img src = "<?php bloginfo('stylesheet_directory');?>/img/_copa/08.jpg" alt = "" /></div>
	</div>	
</div>
