...
<div style="background-color: #EFEEEA; padding: 20px">
	...
	<div class="row encomendas" style="width: auto; margin: 0 auto; text-align: center;">
		...
		<div class="col-lg-6">
		  <img src="<?php bloginfo('stylesheet_directory');?>/img/_copa/03.jpg" alt="" />
		</div>
		
		<div class="col-lg-6">
		  <img src="<?php bloginfo('stylesheet_directory');?>/img/_copa/02.jpg" alt="" />
		</div>

		<div class="col-lg-6">
		  <img src="<?php bloginfo('stylesheet_directory');?>/img/_copa/04.jpg" alt="" />
		</div>
