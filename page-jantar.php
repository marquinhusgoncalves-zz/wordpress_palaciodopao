...
<div style="background-color: #EFEEEA; padding: 20px">
	...
	<div class="row encomendas" style="width: auto; margin: 0 auto; text-align: center;">
		...
		<div class="col-lg-6">
		  <img src="<?php bloginfo('stylesheet_directory');?>/img/_mezanino/06.jpg" alt="" />
		</div>

		<div class="col-lg-6">
		  <img src="<?php bloginfo('stylesheet_directory');?>/img/_mezanino/07.jpg" alt="" />
		</div>

		<div class="col-lg-6">
		  <img src="<?php bloginfo('stylesheet_directory');?>/img/_mezanino/08.jpg" alt="" />
		</div>		
